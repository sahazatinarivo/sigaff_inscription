...
export const ChangeLocChoix2 = ({ typeLoc,formData,setFormData }) => {
    let message;
        ...
        case 'etab':
          message = <>
                        <tr>
                            ...
                            <td>
                                <select className="form-control" name="p2_dren" style={{ textAlign:"center" }} value={formData.p2_dren} onChange={ (e) => ChangeDrens(e) }>
                        ...
                        <tr>
                            ...
                            <td>
                                <select className="form-control" name="p2_cisco" style={{ textAlign:"center" }} value={formData.p2_cisco} onChange={ (e) => ChangeCisco(e) }>
                        ...
                        <tr>
                            ...
                            <td>
                                <select className="form-control" name="p2_etab" value={formData.p2_etab} style={{ textAlign:"center" }} onChange={ (e) => ChangeEtab(e) }>
        ...
        case 'direction':
            message = <>
                        <tr>
                            ...
                            <td>
                                <select className="form-control" name="p2_direction" style={{ textAlign:"center" }} value={formData.p2_direction} onChange={ (e) => ChangeDir(e) }>
                        ...
                        <tr>
                            ...
                            <td>
                                <select className="form-control" name="p2_service" value={formData.p2_service_d} style={{ textAlign:"center" }}>
        ...
        case 'cisco':
            message = <>
                        ...
                        <tr>
                            ...
                            <td>
                                <select className="form-control" name="p2_division_c" value={formData.p2_division_c} style={{ textAlign:"center" }} onChange={ (e) => ChangeDivCisco(e) }>
        ...
        case 'dren':
            message = <>
                        ...
                        <tr>
                            <td style={{ textAlign:'right' }}>SERVICE</td>
                            <td>
                                <select className="form-control" name="p2_service_d" style={{ textAlign:"center" }} value={formData.p2_cisco} onChange={ (e) => ChangeCisco(e) }>
                                    <option value="0" >---SERVICE---</option>
        ...
        case 'crinfp':
            message = <>
                        ...
                        <tr>
                            ...
                            <td>
                                <select className="form-control" name="p2_crinfp" style={{ textAlign:"center" }} value={formData.p2_crinfp} onChange={(e) => ChangeCrinfp(e) }>
    ...
    return  <>
                <tr>
                    ...
                    <td>
                        <select className="form-control" name="p2_fonction" value={formData.p2_fonction} style={{ textAlign:"center" }} onChange={ (e) => ChangeFonction(e) }>
